...
This section is incomplete due to lack of experimentation. It is possible that some Ethernet transformers are not suitable. If your setup does not work with the UF2 image provided then you most likely have an Ethernet signal integrity problem. You can open a GitHub issue but don't expect quick help. Here is a list of things to check:

- If you use two Picos simultaneously **make sure they do not have the same MAC address!** Remember to change it systematically.

- Make sure your program sets the Pico's system clock to exactly **120MHz or 240MHz.** This is listed in the program limitations section.
